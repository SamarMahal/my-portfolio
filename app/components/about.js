      ...
      <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
          <div class="text-center md:text-left">
            ...
            <p class="text-xl md:text-xl text-white mb-8 mr-10">I'm Samar Deep Singh, a software developer dedicated to mastering programming and technology. Explore my portfolio to see my projects and achievements in the tech field.</p>
